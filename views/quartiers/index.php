...
<body>
    ...
    <div class="container">
        <h1 class="mt-5">Liste des quartiers de la commune</h1>
        <!-- Ajout d'un bouton d'ajout stylisé avec Bootstrap -->
        <div class="mb-3">
            <button type="button" class="btn btn-primary mr-8" data-toggle="modal" data-target="#ajouterQuartierModal">
                Ajouter un quartier
            </button>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                // $quartiers = $results->quartiersCivile();
                $quartiers = $results->readQuartiers();
                ...
                foreach ($quartiers as $quartier): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="update.php?id=<?= $quartier['id'] ?>" class="btn btn-primary btn-sm mr-2">
                                <i class="fas fa-edit"></i> Modifier
                            </a>
                            <!-- Bouton de suppression -->
                            <a href="../../controllers/quartierController.php?id=<?= $quartier['id'] ?>"
